...
export const ListModal = ({ handleClose, handleSubmit, show, title, listContent, renderSubmitButtons }: Props) => {
    const [selected, setSelected] = useState<string | null>(null)

    const submitDisabled = selected === undefined
    const submitComponent = renderSubmitButtons ? renderSubmitButtons(submitDisabled, selected) : (
