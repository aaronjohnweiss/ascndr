...
export const isFriendOf = (databaseState: DatabaseState) => normalizeFilterValue((friendUids: Optional<string[]>): FilterPredicate<string> => {
...
export const hasFriend = (databaseState: DatabaseState) => normalizeFilterValue((friendUids: Optional<string[]>): FilterPredicate<string> => (uid: string) => {
