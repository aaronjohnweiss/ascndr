 ...
 */
export const withDefault = <Part, Whole extends Filterable>(selector: () => Optional<OrderedList<Part>>, converter: (part: Part) => Whole): Optional<OrderedList<Whole>> => selector()?.map(persisted => ({
    ...persisted,
 ...
 */
export const normalizeFilterValue = <T, >(func: (x: Optional<string[]>) => T) => (((y: FilterValue) => {
