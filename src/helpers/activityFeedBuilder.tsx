...
const FeedItemTypes: FeedItemType[] = ['project', 'milestone', 'video', 'session', 'workout']
...
const getGradeMilestoneFeedItems = (
  ...
  return entries(sessionsByUser).flatMap(([uid, userSessions]) => {
    ...
    const milestones = calculateProgression(
      userSessions,
      toObj(routes),
      true,
      [...ALL_STYLES],
...
const getProjectFeedItems = (
  ...
  return routes.flatMap(route =>
    calculateProjectTimes(route.key, sessionsByUser)
 ...
 */
const isMilestoneCount = (n: number) =>
  lowMilestones.some(milestone => n === milestone) || n % 100 === 0
